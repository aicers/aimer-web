...
available"** 안내를 표시하며, 이는 분석 페이지의 고정 증거 동작과
동일합니다.
...
![재생성 확인 모달로, 구간의 스토리·이벤트·의심 이벤트 동향 전반에 새 LLM 호출이 발생하고 최신 세대가 슈퍼시드된다는 경고와 Cancel, Regenerate 버튼이 표시됨](../../assets/report-regenerate-modal.ko.png)
