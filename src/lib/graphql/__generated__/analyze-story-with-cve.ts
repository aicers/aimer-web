...
export interface AnalyzeStoryWithCveVariables {
  customerId: string;
  storyId: string;
...
export interface AnalyzeStoryWithCveResponse {
  analyzeStory: StoryAnalysisResult;
}

export const ANALYZE_STORY_WITH_CVE_SOURCE = `mutation AnalyzeStoryWithCve(
  $customerId: ID!
  $storyId: ID!
...
const document: DocumentNode = parse(ANALYZE_STORY_WITH_CVE_SOURCE);
...
const typedDocument = document as unknown as TypedDocumentNode<
  AnalyzeStoryWithCveResponse,
  AnalyzeStoryWithCveVariables
>;

export const AnalyzeStoryWithCveDocument = typedDocument;
