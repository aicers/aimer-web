...
//
// The functions below are shared between (a) the ingest hooks that mark
// state rows dirty and (b) the worker tick that promotes pending → ready
// and enqueues new jobs.
