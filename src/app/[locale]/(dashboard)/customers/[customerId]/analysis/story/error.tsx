...
// WS3 (#392) — error state for the Threat Stories list. A client boundary
// rendered when the server component throws (e.g. the keyset query fails).
export default function ThreatStoriesError({
  reset,
}: {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      >
        <p>Failed to load threat stories.</p>
        <button
          type="button"
          onClick={reset}
