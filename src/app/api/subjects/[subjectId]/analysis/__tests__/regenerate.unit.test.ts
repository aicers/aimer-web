...
function storyRequest(query = ""): NextRequest {
  return new NextRequest(
    new URL(
      `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/story/12345/regenerate${query}`,
    ),
    { method: "POST" },
  );
}
...
function reportRequest(query = ""): NextRequest {
  return new NextRequest(
    new URL(
      `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/DAILY/2026-05-27/regenerate${query}`,
    ),
    { method: "POST" },
  );
}
...
describe("story regenerate", () => {
  ...
  it("returns 400 on an invalid story id", async () => {
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/story/not-a-number/regenerate`,
      ),
      { method: "POST" },
    );
...
describe("report regenerate (Phase 2 #297)", () => {
  ...
  it.each([
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/${period}/2026-05-27/regenerate?tz=Asia/Tokyo`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it("a denied caller requesting WEEKLY still sees its denial code", async () => {
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/WEEKLY/2026-05-27/regenerate?tz=Asia/Tokyo`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it("returns 400 on an unknown period", async () => {
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/HOURLY/2026-05-27/regenerate`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it("returns 400 on a malformed bucket_date", async () => {
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/DAILY/today/regenerate`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it.each([
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/DAILY/${bucketDate}/regenerate`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it.each([
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/LIVE/${bucketDate}/regenerate`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it("accepts period=LIVE with bucket_date=1970-01-01", async () => {
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/LIVE/1970-01-01/regenerate?tz=Asia/Tokyo`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
  ...
  it("accepts a real leap-year date (2024-02-29)", async () => {
    ...
    const req = new NextRequest(
      new URL(
        `http://localhost:3000/api/subjects/${CUSTOMER_ID}/analysis/report/DAILY/2024-02-29/regenerate?tz=Asia/Tokyo`,
      ),
      { method: "POST" },
    );
    const res = await POST(req);
